    ...
    pub mod golem {
        pub mod exec {
            ...
            pub mod exec_stream {
                ...
                pub type ExecEvent = super::super::super::super::golem::exec::types::ExecEvent;
                #[derive(Debug)]
                #[repr(transparent)]
                ...
                unsafe impl _rt::WasmResource for ExecStream {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]golem:exec/exec-stream@0.1.0"
                            )]
                            unsafe extern "C" {
                    ...
                    match result0 {
                        Some(e) => {
                            *ptr1.add(0).cast::<u8>() = (1i32) as u8;
                            use super::super::super::super::golem::exec::types::ExecEvent as V23;
                            match e {
                                V23::StdoutChunk(e) => {
                                ...
                                V23::Failed(e) => {
                                    *ptr1.add(8).cast::<u8>() = (3i32) as u8;
                                    use super::super::super::super::golem::exec::types::Error as V22;
                                    match e {
                ...
                #[doc(hidden)]
                macro_rules! __export_golem_exec_exec_stream_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "golem:exec/exec-stream@0.1.0#[method]exec-stream.get-next")]
                        ...
                        (export_name =
                        "cabi_post_golem:exec/exec-stream@0.1.0#[method]exec-stream.get-next")]
                        unsafe extern "C" fn
                        ...
                        $($path_to_types)*:: Guest >::ExecStream > (arg0) } } #[unsafe
                        (export_name =
                        "golem:exec/exec-stream@0.1.0#[method]exec-stream.blocking-get-next")]
                        unsafe extern "C" fn
                        ...
                        * mut u8 { unsafe { $($path_to_types)*::
                        ...
                        $($path_to_types)*:: Guest >::ExecStream > (arg0) } } #[unsafe
                        (export_name =
                        "cabi_post_golem:exec/exec-stream@0.1.0#[method]exec-stream.blocking-get-next")]
                        unsafe extern "C" fn
                        ...
                        "golem:exec/exec-stream@0.1.0#[dtor]exec-stream")]
                ...
                #[doc(hidden)]
                pub(crate) use __export_golem_exec_exec_stream_0_1_0_cabi;
                #[repr(align(8))]
                struct _RetArea(
            ...
            pub mod executor {
                ...
                pub type ExecStream = super::super::super::super::exports::golem::exec::exec_stream::ExecStream;
                pub type ExecStreamBorrow<'a> = super::super::super::super::exports::golem::exec::exec_stream::ExecStreamBorrow<
                    'a,
                >;
                #[doc(hidden)]
                #[allow(non_snake_case)]
                ...
                pub unsafe fn _export_run_streaming_cabi<T: Guest>(
                    ...
                    match result44 {
                        ...
                        Err(e) => {
                            *ptr45.add(0).cast::<u8>() = (1i32) as u8;
                            use super::super::super::super::golem::exec::types::Error as V55;
                            match e {
                ...
                macro_rules! __export_golem_exec_executor_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        #[unsafe (export_name =
                        "golem:exec/executor@0.1.0#run-streaming")] unsafe extern "C" fn
                        export_run_streaming(arg0 : * mut u8,) -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_run_streaming_cabi::<$ty > (arg0) }
                        } #[unsafe (export_name =
                        "cabi_post_golem:exec/executor@0.1.0#run-streaming")] unsafe
            ...
            pub mod session {
                ...
                unsafe impl _rt::WasmResource for Session {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]golem:exec/session@0.1.0"
                            )]
                            unsafe extern "C" {
                ...
                pub unsafe fn _export_method_session_run_streaming_cabi<T: GuestSession>(
                    ...
                    match result32 {
                        ...
                        Err(e) => {
                            *ptr33.add(0).cast::<u8>() = (1i32) as u8;
                            use super::super::super::super::golem::exec::types::Error as V43;
                            match e {
                ...
                #[doc(hidden)]
                macro_rules! __export_golem_exec_session_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "golem:exec/session@0.1.0#[constructor]session")] unsafe extern
                        ...
                        * mut u8, arg3 : usize,) -> i32 { unsafe { $($path_to_types)*::
                        ...
                        (export_name =
                        "golem:exec/session@0.1.0#[method]session.upload")] unsafe extern
                        ...
                        #[unsafe (export_name =
                        "cabi_post_golem:exec/session@0.1.0#[method]session.upload")]
                        ...
                        (export_name = "golem:exec/session@0.1.0#[method]session.run")]
                        ...
                        "cabi_post_golem:exec/session@0.1.0#[method]session.run")] unsafe
                        extern "C" fn _post_return_method_session_run(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*::
                        __post_return_method_session_run::<<$ty as $($path_to_types)*::
                        Guest >::Session > (arg0) } } #[unsafe (export_name =
                        "golem:exec/session@0.1.0#[method]session.run-streaming")] unsafe
                        ...
                        $($path_to_types)*:: Guest >::Session > (arg0) } } #[unsafe
                        (export_name =
                        "cabi_post_golem:exec/session@0.1.0#[method]session.run-streaming")]
                        unsafe extern "C" fn
                        ...
                        $($path_to_types)*:: Guest >::Session > (arg0) } } #[unsafe
                        (export_name =
                        "golem:exec/session@0.1.0#[method]session.download")] unsafe
                        ...
                        #[unsafe (export_name =
                        "cabi_post_golem:exec/session@0.1.0#[method]session.download")]
                        unsafe extern "C" fn _post_return_method_session_download(arg0 :
                        * mut u8,) { unsafe { $($path_to_types)*::
                        __post_return_method_session_download::<<$ty as
                        $($path_to_types)*:: Guest >::Session > (arg0) } } #[unsafe
                        (export_name =
                        "golem:exec/session@0.1.0#[method]session.list-files")] unsafe
                        ...
                        #[unsafe (export_name =
                        "cabi_post_golem:exec/session@0.1.0#[method]session.list-files")]
                        unsafe extern "C" fn _post_return_method_session_list_files(arg0
                        : * mut u8,) { unsafe { $($path_to_types)*::
                        __post_return_method_session_list_files::<<$ty as
                        $($path_to_types)*:: Guest >::Session > (arg0) } } #[unsafe
                        (export_name =
                        "golem:exec/session@0.1.0#[method]session.set-working-dir")]
                        ...
                        * mut u8, arg1 : * mut u8, arg2 : usize,) -> * mut u8 { unsafe {
                        ...
                        $($path_to_types)*:: Guest >::Session > (arg0, arg1, arg2) } }
                        #[unsafe (export_name =
                        "cabi_post_golem:exec/session@0.1.0#[method]session.set-working-dir")]
                        unsafe extern "C" fn
                        _post_return_method_session_set_working_dir(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*::
                        __post_return_method_session_set_working_dir::<<$ty as
                        $($path_to_types)*:: Guest >::Session > (arg0) } } #[unsafe
                        (export_name = "golem:exec/session@0.1.0#[method]session.close")]
                        ...
                        #[unsafe (export_name =
                        "golem:exec/session@0.1.0#[dtor]session")]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                ...
                #[doc(hidden)]
                pub(crate) use __export_golem_exec_session_0_1_0_cabi;
                #[repr(align(8))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
                        u8,
...
macro_rules! __export_exec_library_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::golem::exec::exec_stream::__export_golem_exec_exec_stream_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::golem::exec::exec_stream);
        $($path_to_types_root)*::
        ...
        $($path_to_types_root)*::
        exports::golem::exec::session::__export_golem_exec_session_0_1_0_cabi!($ty
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:golem:exec@0.1.0:exec-library:encoded world"
)]
#[doc(hidden)]
...
es@0.1.0\x05\0\x02\x03\0\0\x0aexec-event\x01B\x08\x02\x03\x02\x01\x01\x04\0\x0ae\
xec-event\x03\0\0\x04\0\x0bexec-stream\x03\x01\x01h\x02\x01k\x01\x01@\x01\x04sel\
f\x03\0\x04\x04\0\x1c[method]exec-stream.get-next\x01\x05\x04\0%[method]exec-str\
eam.blocking-get-next\x01\x05\x04\0\x1cgolem:exec/exec-stream@0.1.0\x05\x02\x02\x03\
\0\0\x08language\x02\x03\0\0\x04file\x02\x03\0\0\x06limits\x02\x03\0\0\x0bexec-r\
esult\x02\x03\0\0\x05error\x02\x03\0\x01\x0bexec-stream\x01B\x1b\x02\x03\x02\x01\
\x03\x04\0\x08language\x03\0\0\x02\x03\x02\x01\x04\x04\0\x04file\x03\0\x02\x02\x03\
\x02\x01\x05\x04\0\x06limits\x03\0\x04\x02\x03\x02\x01\x06\x04\0\x0bexec-result\x03\
\0\x06\x02\x03\x02\x01\x07\x04\0\x05error\x03\0\x08\x02\x03\x02\x01\x01\x04\0\x0a\
exec-event\x03\0\x0a\x02\x03\x02\x01\x08\x04\0\x0bexec-stream\x03\0\x0c\x01p\x03\
\x01ks\x01ps\x01o\x02ss\x01p\x11\x01k\x05\x01j\x01\x07\x01\x09\x01@\x06\x04lang\x01\
\x05files\x0e\x05stdin\x0f\x04args\x10\x03env\x12\x0bconstraints\x13\0\x14\x04\0\
\x03run\x01\x15\x01i\x0d\x01j\x01\x16\x01\x09\x01@\x06\x04lang\x01\x05files\x0e\x05\
stdin\x0f\x04args\x10\x03env\x12\x0bconstraints\x13\0\x17\x04\0\x0drun-streaming\
\x01\x18\x04\0\x19golem:exec/executor@0.1.0\x05\x09\x01B-\x02\x03\x02\x01\x03\x04\
\0\x08language\x03\0\0\x02\x03\x02\x01\x04\x04\0\x04file\x03\0\x02\x02\x03\x02\x01\
\x05\x04\0\x06limits\x03\0\x04\x02\x03\x02\x01\x06\x04\0\x0bexec-result\x03\0\x06\
\x02\x03\x02\x01\x07\x04\0\x05error\x03\0\x08\x02\x03\x02\x01\x01\x04\0\x0aexec-\
event\x03\0\x0a\x02\x03\x02\x01\x08\x04\0\x0bexec-stream\x03\0\x0c\x04\0\x07sess\
ion\x03\x01\x01i\x0e\x01@\x01\x04lang\x01\0\x0f\x04\0\x14[constructor]session\x01\
\x10\x01h\x0e\x01j\0\x01\x09\x01@\x02\x04self\x11\x04file\x03\0\x12\x04\0\x16[me\
thod]session.upload\x01\x13\x01ps\x01ks\x01o\x02ss\x01p\x16\x01k\x05\x01j\x01\x07\
\x01\x09\x01@\x06\x04self\x11\x0aentrypoints\x04args\x14\x05stdin\x15\x03env\x17\
\x0bconstraints\x18\0\x19\x04\0\x13[method]session.run\x01\x1a\x01i\x0d\x01j\x01\
\x1b\x01\x09\x01@\x06\x04self\x11\x0aentrypoints\x04args\x14\x05stdin\x15\x03env\
\x17\x0bconstraints\x18\0\x1c\x04\0\x1d[method]session.run-streaming\x01\x1d\x01\
p}\x01j\x01\x1e\x01\x09\x01@\x02\x04self\x11\x04paths\0\x1f\x04\0\x18[method]ses\
sion.download\x01\x20\x01j\x01\x14\x01\x09\x01@\x02\x04self\x11\x03dirs\0!\x04\0\
\x1a[method]session.list-files\x01\"\x01@\x02\x04self\x11\x04paths\0\x12\x04\0\x1f\
[method]session.set-working-dir\x01#\x01@\x01\x04self\x11\x01\0\x04\0\x15[method\
]session.close\x01$\x04\0\x18golem:exec/session@0.1.0\x05\x0a\x04\0\x1dgolem:exe\
c/exec-library@0.1.0\x04\0\x0b\x12\x01\0\x0cexec-library\x03\0\0\0G\x09producers\
