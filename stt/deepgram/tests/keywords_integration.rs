...
fn keywords_integration() {
    ...
    let mut opts = TranscribeOptions { enable_timestamps: None, enable_speaker_diarization: None, language: None, model: None, profanity_filter: None, speech_context: Some(vec!["hello".to_string(), "world".to_string()]), enable_word_confidence: None, enable_timing_detail: None };
