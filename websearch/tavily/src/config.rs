//! Configuration types for the Tavily web search provider.
...
pub struct TavilyHostConfig {
    #[config_schema(secret)]
    pub api_key: golem_rust::agentic::Secret<String>,
}

#[cfg(feature = "golem")]
impl From<TavilyHostConfig> for TavilyConfig {
    fn from(host: TavilyHostConfig) -> Self {
        Self {
